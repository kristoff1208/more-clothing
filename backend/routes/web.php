...
// 共通画面：レンタル商品
Route::get('rental', [RentalController::class, 'rentalIndex'])->name('rental');
Route::get('rental/detail/{id}', [RentalController::class, 'rentalShow'])->name('rental.detail');
...
Route::prefix('admin')->name('admin.')->group(function () {
    Route::middleware('auth:manager')->group(function () {
        ...
        // 担当者を追加
        Route::get('add/charge', [AdminController::class, 'chargeAdd'])->name('add.charge');
        Route::post('add/charge', [AdminController::class, 'chargeAddPost'])->name('add.charge.post');
        // レンタルユーザーを追加
        ...
        // 支店を追加
        Route::get('add/branch', [AdminController::class, 'branchAdd'])->name('add.branch');
        Route::post('add/branch', [AdminController::class, 'branchAddPost'])->name('add.branch.post');
        ...
        // 担当者一覧
        Route::get('list/charge', [AdminController::class, 'chargeList'])->name('list.charge');
        Route::post('list/charge/stop', [AdminController::class, 'chargeEditStop'])->name('edit.charge.stop');
        ...
        // 支店一覧
        Route::get('list/branch', [AdminController::class, 'branchList'])->name('list.branch');
        // 支店詳細
        Route::get('list/branch/{id}', [AdminController::class, 'branchShow'])->name('show.branch');
        // 支店停止
        Route::post('list/branch/stop', [AdminController::class, 'branchEditStop'])->name('edit.branch.stop');
        // 支店編集
        Route::get('edit/branch', [AdminController::class, 'branchEditUpdate'])->name('edit.branch.update');
        Route::post('edit/branch', [AdminController::class, 'branchEditStore'])->name('edit.branch.store');
