        ...
        <ul class="uk-nav uk-nav-default">
            ...
            <li class="uk-parent">
                <ul class="uk-nav-sub">
                    ...
                    <li><a href="{{ route('admin.add.branch') }}">支店を追加</a></li>
                    <li><a href="{{ route('admin.add.charge') }}">担当者を追加</a></li>
        ...
        <ul class="uk-nav uk-nav-default">
            ...
            <li class="uk-parent">
                <ul class="uk-nav-sub">
                    ...
                    <li><a href="{{ route('admin.list.branch') }}">支店</a></li>
                    <li><a href="{{ route('admin.list.charge') }}">担当者</a></li>
