...
@section('content')
    ...
    <div class="admin-body">
        <form method="POST" action="{{ route('admin.add.charge.post') }}">
        @csrf
                    ...
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="name1" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="name2" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
