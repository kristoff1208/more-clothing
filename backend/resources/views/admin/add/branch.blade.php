...
@section('content')
    ...
    <div class="admin-body">
        <form method="POST" action="{{ route('admin.add.branch.post') }}">
        @csrf
            ...
            <table style="width: auto;" class="uk-table uk-table-responsive uk-table-divider">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="email" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="tel" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="post" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 400px;">
                            <div class="user__content__box__gray u-p0">
                                <input type="text" name="address1" class="uk-input user__content__box__gray__inner">
                            </div>
                        </td>
                    </tr>
                    <tr>
