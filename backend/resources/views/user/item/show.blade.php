                        ...
                        @elseif($item->status == 'now_store' || $item->status == 'negotiate_rental' || $item->status == 'now_rental')
                            <div class="u-w49per">
                                <form method="POST" action="">
                                    ...
                                    <a class="c-button c-button--big c-button--blue u-w100per" href="{{ route('custody.sales.request.two', ['item_id' => $item->id, 'url' => $item_image->url ?? '']) }}">販売代行を依頼</a>
                            ...
                            <div class="u-w49per">
                                @if($item->status == 'now_store')
                                <a class="c-button c-button--big c-button--blue u-w100per" href="{{ route('custody.rental.request.two', ['item_id' => $item->id, 'url' => $item_image->url ?? '']) }}">レンタルに出品する</a>
                                @elseif($item->status == 'negotiate_rental' || $item->status == 'now_rental')
