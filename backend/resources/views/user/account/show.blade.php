    ...
    <div class="user__content__box">
        <div class="user__content__box__inner">
            <div class="user__content__box__info l-flex">
                ...
                <div class="u-wflex1">{{ $user->name1 }} {{ $user->name2 }}</div>
            </div>
            <div class="user__content__box__info l-flex">
                <div class="u-w130 u-text--bold">カナ</div>
                <div class="u-wflex1">{{ $user->kana1 }} {{ $user->kana2 }}</div>
            </div>
            <div class="user__content__box__info l-flex">
            ...
            <div class="user__content__box__info l-flex">
                ...
                <div class="u-wflex1">{{ $user->tel }}</div>
            </div>
            <div class="user__content__box__info l-flex">
                <div class="u-w130 u-text--bold">郵便番号</div>
                <div class="u-wflex1">{{ $user->post }}</div>
            </div>
            <div class="user__content__box__info l-flex">
                <div class="u-w130 u-text--bold">住所</div>
                <div class="u-wflex1">{{ $user->address1 }}<br>{{ $user->address2 }}</div>
            </div>
        </div>
    </div>
</section>
