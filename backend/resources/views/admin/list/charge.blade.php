...
@section('content')
    ...
    <div id="modal-delete" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.edit.charge.stop') }}" enctype="multipart/form-data">
                @csrf
        ...
        <table class="uk-table uk-table-responsive uk-table-divider uk-table-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $charge->name1 }} {{ $charge->name2 }}</td>
                    <td>{{ $charge->email }}</td>
                    <td>{{ $charge->memo }}</td>
                    <td style="white-space: nowrap">
                        <button class="c-button c-button--bgPink u-mr10" type="button" uk-toggle="target: #modal-delete" onclick="event.preventDefault();document.getElementById('target_id').value = {{ $charge->id }}">削除</button>
