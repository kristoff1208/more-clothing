	...
	export default {
        ...
        created: function() {
            ...
            if(this.courseDate[0]) {
                ...
                this.couseDetailFiles[0].url = this.courseDate[0].url;
            ...
            if(this.courseDate[1]) {
                this.couseDetailFiles[1].url = this.courseDate[1].url;
            ...
            if(this.courseDate[2]) {
                this.couseDetailFiles[2].url = this.courseDate[2].url;
            ...
            if(this.courseDate[3]) {
                this.couseDetailFiles[3].url = this.courseDate[3].url;
            ...
            if(this.courseDate[4]) {
                this.couseDetailFiles[4].url = this.courseDate[4].url;
        ...
        methods: {
			...
			deleteFile: function(index, id) {
                ...
                // 画像を削除
                axios.post('/api/item-image/delete', params)
                    .then(result => {
