                ...
                <div class="user__content__box__inner">
                    ...
                    <div class="user__content__box__gray l-flex">
                        <div class="u-w49per">
                            ...
                            <input type="text" name="branch_number" class="uk-input user__content__box__gray__inner" placeholder="123" :value="sessions['branch_number']" required="required">
                        </div>
                        <div class="u-w49per">
                            <p class="sub-headline">支店名</p>
                            <input type="text" name="branch_name" class="uk-input user__content__box__gray__inner" placeholder="本店" :value="sessions['branch_name']" required="required">
                        </div>
                    </div>
                    <div class="user__content__box__gray l-flex">
                        <div class="u-w49per">
