            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($withdrawal->bank_type_id == 1){{ $withdrawal->financial_name }} {{ $withdrawal->branch_name }} {{ $withdrawal->branch_number }} {{ $withdrawal->other_type }} {{ $withdrawal->other_number }} {{ $withdrawal->other_name }}
                        @endif
                    </td>
                    <td>{{ number_format($withdrawal->price) }}円<br>（{{ number_format($withdrawal->fee) }}円/{{ number_format($withdrawal->transfer) }}円）</td>
                    <td>{{ $withdrawal->charge_name1 }} {{ $withdrawal->charge_name2 }}</td>
                </tr>
                @endforeach
                {{-- <tr>
                    <td>2020.01.01</td>
