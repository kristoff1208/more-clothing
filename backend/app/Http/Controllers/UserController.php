...
class UserController extends Controller
{
    ...
    public function paymentRequestConfirmPost(Request $request)
    {
        ...
        try {
            ...
            if($input['bank_type'] == 0) {
                ...
                $params['branch_number']  = $input['branch_number'];
    ...
    public function accountUpdate(StoreUserRequest $request) {
        ...
        $user->name1 = $validated['name1'];
        $user->name2 = $validated['name2'];
        $user->kana1 = $validated['kana1'];
        $user->kana2 = $validated['kana2'];
        $user->email = $validated['email'];
        $user->tel = $validated['tel'];
        $user->post = $validated['post'];
