        ...
        <table class="uk-table uk-table-middle uk-table-responsive uk-table-divider">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('admin.show.rental.user', $rentalTrade->charge_id) }}">{{ $rentalTrade->rental_user_name1 }} {{ $rentalTrade->rental_user_name2 }}</a></td>
                    <td>{{ number_format($rentalTrade->price) }}円 / {{ number_format($rentalTrade->fee) }}円</td>
                    <td>{{ $rentalTrade->charge_name1 }} {{ $rentalTrade->charge_name2 }}</td>
                </tr>
                @endforeach
                {{-- <tr>
                    <td>2020.01.01</td>
